...
module.exports = class {
	constructor(configuration) {
		...
		this._pid = new Pid(configuration.setPoint, configuration.pid.tempSensorId, configuration.pid.proportionalGain, configuration.pid.integralGain, configuration.pid.differentialGain);
